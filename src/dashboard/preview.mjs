...
export function previewMatrix(spec, { configDirectory }) {
  ...
  const repetitions = positiveInteger(spec.repetitions, 1, "repetitions"), presetRepetitions = spec.presetRepetitions || {}, presetOverrides = spec.presetOverrides || {};
  ...
  for (const file of files) {
    ...
    const compatibleOverrides = { ...overrides, ...(presetOverrides[file] || {}) };
